    ...
    template: {
      ...
      spec: {
        ...
        volumes: [
          ...
          { name: 'browserstack-tests-ssh-keys', secret: { secretName: 'browserstack-tests-ssh', defaultMode: 256 } },
          { name: 'ssh-keys', secret: { secretName: 'buildkite-agent-ssh', defaultMode: 256 } },
